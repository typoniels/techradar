...
import {messageHelper, translate} from '../../common/config';
          ...
          <div className="item-page__nav">
            <div className="item-page__nav__inner">
              <div className="item-page__header" style={this.getAnimationState('navHeader')}>
                ...
                <p style={{color: "white"}}>{messageHelper(item.quadrant, 'teaser')}</p>
              </div>
                ...
                <div className="split">
                  ...
                  <div className="split__right">
                    <Link className="icon-link" pageName={item.quadrant}>
                      <span className="icon icon--pie icon-link__icon"></span>Rubikübersicht
                    </Link>
                  </div>
                </div>
              </ItemList>
